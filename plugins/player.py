        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**🥀 𝗣𝗹𝗲𝗮𝘀𝗲 𝗨𝗻𝗕𝗮𝗻 𝗚𝗿𝗼𝗼𝘁 𝗠𝘂𝘀𝗶𝗰 [𝗔𝘀𝘀𝗶𝘀𝘁𝗮𝗻𝘁](t.me/{ASSISTANT_USERNAME}) 🎸 𝗜𝗻 𝗧𝗵𝗶𝘀 𝗚𝗿𝗼𝘂𝗽 𝗢𝗿 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗧𝗼 [𝗕𝗼𝘁 𝗢𝘄𝗻𝗲𝗿 ](https://t.me/{OWNER_USERNAME}) ✨ **")
    try:
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**🌱 𝗚𝗿𝗼𝗼𝘁 𝗥𝗼𝗯𝗼𝘁 𝗡𝗼𝘁𝗵𝗶𝗻𝗴 🔇\n🚫 𝗣𝗹𝗮𝘆𝗶𝗻𝗴 😐 ...**")
    else:
